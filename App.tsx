        ...
        <View style={styles.homeContainer}>
          ...
          <View style={styles.tipsSection}>
            ...
            <View style={styles.tipCard}>
              ...
              <Text style={styles.tipText}>🗑️ Long press any menu item to remove it</Text>
            </View>
          </View>
      ...
      <View style={styles.infoCard}>
        ...
        <View style={styles.socialMediaContainer}>
          <View style={styles.socialMediaItem}>
            <Text style={styles.socialMediaIcon}>Instagram</Text>
          ...
          <View style={styles.socialMediaItem}>
            <Text style={styles.socialMediaIcon}>X</Text>
            <Text style={styles.socialMediaHandle}>
          ...
          <View style={styles.socialMediaItem}>
            <Text style={styles.socialMediaIcon}>Twitter</Text>
            <Text style={styles.socialMediaHandle}>
